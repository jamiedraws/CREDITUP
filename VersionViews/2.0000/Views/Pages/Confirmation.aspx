		...
		<main aria-labelledby="main-title" class="view conf section">
			...
			<div class="view__in section__in">
				...
				<div class="conf__text">
					...
					<p>Click <a href="<%= signin.Page %>" target="_blank"><%= signin.Name %></a> below to access the CreditUp dashboard and complete your application. Your email address is your CreditUp username. Enter your temporary password then click <a href="<%= signin.Page %>" target="_blank"><%= signin.Name %></a>!</p>

...
<html class="dtm" lang="en">
	...
	<body class="dtm__in">
		...
		<main aria-labelledby="application-process-title" class="view application-process application-process--conf section">
			<div id="main" class="view__anchor"></div>
			<div id="how-it-works" class="view__anchor"></div>
			<div class="view__in section__in">
				<div class="section__block application-process__banner">
					<h1 id="main-title" class="application-process__title">We're so glad you're joining <b>CreditUp!</b></h1>
				</div>

				<div class="application-process__grid">
					<header class="application-process__header">
						<h2 id="application-process-title" class="application-process__title">How It Works - 3 Easy Steps</h2>
					</header>
					<ul class="application-process__step-list">
						<li data-step-icon="bank">
							<div class="application-process__step">
								<h3>Step 1</h3>
								<p>Enter your personal and bank details*</p>
								<small>May also send in a check payment by mail.</small>
							</div>
						</li>
						<li data-step-icon="cursor">
							<div class="application-process__step">
								<h3>Step 2</h3>
								<p>Review and select program terms</p>
							</div>
						</li>
						<li data-step-icon="paper">
							<div class="application-process__step">
								<h3>Step 3</h3>
					...
					<footer class="application-process__footer">
						<p>Click <a href="<%= signin.Page %>" target="_blank"><%= signin.Name %></a> below to access the CreditUp dashboard and complete your application. Your email address is your CreditUp username. Enter your temporary password on the CreditUp account portal and click <a href="<%= signin.Page %>" target="_blank"><%= signin.Name %></a></p>

						<div class="application-process__note">
							<p><b>Please have a form of identification ready when you begin your application.</b><br>You will need a state issued Identification Card, valid state issued Driver&rsquo;s License, or current U.S. Passport.</p>
							<p>An email will be sent to the account email confirming your account credentials.</p>
						</div>

						<p><b>Once your CreditUp application is approved</b>, 5Star Bank will create two separate accounts in your name: a loan account and a savings account. In order to finalize your CreditUp account, you will need to sign your Savings Deposit Contracts via E-sign AND you will need to sign Loan Contracts that will be delivered via email. Your first payment and monthly thereafter will be due 30 days past the day your CreditUp account was created. </p>

						<p><b>Now, you&rsquo;re on your way to building your CreditUp!</b></p>
					</footer>
				</div>

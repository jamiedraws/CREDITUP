<%@ Page Language="C#" MasterPageFile="~/VersionViews/5.0000/Views/Layouts/MainLayout.master" Inherits="System.Web.Mvc.ViewPage<LeadGenPageViewData>" %>
        ...
        <div class="fieldset__group">
            ...
            <div class="fieldset__take-all fieldset__content">
                ...
                <p class="fieldset__disclaimer">
                    <b>Note:</b> The CreditUp by 5Star credit builder is not an upfront cash loan program.
                </p>
            </div>
        </div>
	</fieldset>

...
/* harmony import */ var Shared_ts_components_status_screen__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! Shared/ts/components/status-screen */ "../../Shared-International/ts/components/status-screen.ts");
/* harmony import */ var Shared_ts_utils_data__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(/*! Shared/ts/utils/data */ "../../Shared-International/ts/utils/data.ts");
/* harmony import */ var Shared_ts_utils_element_controller__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(/*! Shared/ts/utils/element-controller */ "../../Shared-International/ts/utils/element-controller.ts");
/* harmony import */ var Shared_ts_utils_capture_element__WEBPACK_IMPORTED_MODULE_28__ = __webpack_require__(/*! Shared/ts/utils/capture-element */ "../../Shared-International/ts/utils/capture-element.ts");
/* harmony import */ var Shared_ts_utils_validate_event__WEBPACK_IMPORTED_MODULE_29__ = __webpack_require__(/*! Shared/ts/utils/validate-event */ "../../Shared-International/ts/utils/validate-event.ts");
/* harmony import */ var Shared_ts_utils_upsell_action_quantity_reloactor__WEBPACK_IMPORTED_MODULE_30__ = __webpack_require__(/*! Shared/ts/utils/upsell-action-quantity-reloactor */ "../../Shared-International/ts/utils/upsell-action-quantity-reloactor.ts");
...
var initializeValidateEvent = function initializeValidateEvent(form, submit, attribute) {
  ...
  var validateEvent = new Shared_ts_utils_validate_event__WEBPACK_IMPORTED_MODULE_29__["default"]({
    form: form,
    attribute: attribute,
...
var initializeValidateEventWithAjaxSubmit = function initializeValidateEventWithAjaxSubmit(form, submit, outputResponseHandler, attribute) {
  ...
  var outputResponse = (0,Shared_ts_utils_data__WEBPACK_IMPORTED_MODULE_26__.isFunction)(outputResponseHandler) ? outputResponseHandler : function (message, status) {
...
var initializeValidateCommonWithBraintree = function initializeValidateCommonWithBraintree(form) {
  ...
  var captureForm = new Shared_ts_utils_capture_element__WEBPACK_IMPORTED_MODULE_28__["default"](validateCommon.form);
...
var validateByElementController = function validateByElementController(validateEvent) {
  ...
  candidates.forEach(function (candidate) {
    var elementController = new Shared_ts_utils_element_controller__WEBPACK_IMPORTED_MODULE_27__["default"](candidate);
    elementController.controllers.forEach(function (controller) {
    ...
    elementController.elements.forEach(function (element) {
      if (!element) return;
      var captureElement = new Shared_ts_utils_capture_element__WEBPACK_IMPORTED_MODULE_28__["default"](element);
...
var initializeValidateEventNavigator = function initializeValidateEventNavigator(form, submit) {
  ...
  var elementController = new Shared_ts_utils_element_controller__WEBPACK_IMPORTED_MODULE_27__["default"](form);
...
var relocateThenValidateUpsellActionQuantities = function relocateThenValidateUpsellActionQuantities(selector) {
  ...
  if (!form) return;
  var upsellActionQuantityRelocator = new Shared_ts_utils_upsell_action_quantity_reloactor__WEBPACK_IMPORTED_MODULE_30__["default"](form); // todo: add client-side validation
};
var validatePromoCodeAroundStatusScreen = function validatePromoCodeAroundStatusScreen() {
  ...
  var statusScreen = new Shared_ts_components_status_screen__WEBPACK_IMPORTED_MODULE_25__["default"]("inline", statusContainer);
...
/* harmony export */ });
/* unused harmony exports initializeGlobalFlyoutRepository, initializeFlyouts, initializeFlyoutsThenNav, importScrollableHeightByElementIntoStyleElement */
/* harmony import */ var core_js_modules_es_array_iterator_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/es.array.iterator.js */ "../../node_modules/core-js/modules/es.array.iterator.js");
/* harmony import */ var core_js_modules_es_array_iterator_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_array_iterator_js__WEBPACK_IMPORTED_MODULE_0__);
...
/* harmony import */ var Shared_ts_utils_flyout__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! Shared/ts/utils/flyout */ "../../Shared-International/ts/utils/flyout.ts");
...
var initializeFlyouts = function initializeFlyouts(selector) {
  ...
  elements.forEach(function (element) {
    var flyout = new Shared_ts_utils_flyout__WEBPACK_IMPORTED_MODULE_11__["default"](element);
...
var Nav = /*#__PURE__*/function () {
  ...
  function Nav(id) {
    ...
    if (root) {
      this.links = Array.from(root.querySelectorAll("a.nav__link")).filter(function (link) {
        return !link.hasAttribute("aria-haspopup") && !link.hasAttribute("aria-expanded");
      });

      focusNavigator.considerElements = function () {
...
"use strict";
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "navigateToPageSectionOnLoad": function() { return /* binding */ navigateToPageSectionOnLoad; }
/* harmony export */ });
/* unused harmony export navigateToPageSection */
var navigateToPageSection = function navigateToPageSection() {
...
var navigateToPageSectionOnLoad = function navigateToPageSectionOnLoad() {
...
/***/ "./ts/components/page-section-nav.ts":
/*!*******************************************!*\
  !*** ./ts/components/page-section-nav.ts ***!
  \*******************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
"use strict";
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": function() { return /* binding */ PageSectionNav; }
/* harmony export */ });
/* harmony import */ var regenerator_runtime_runtime_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! regenerator-runtime/runtime.js */ "../../node_modules/regenerator-runtime/runtime.js");
/* harmony import */ var regenerator_runtime_runtime_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(regenerator_runtime_runtime_js__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var core_js_modules_es_object_to_string_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! core-js/modules/es.object.to-string.js */ "../../node_modules/core-js/modules/es.object.to-string.js");
...
/* harmony import */ var core_js_modules_es_string_anchor_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! core-js/modules/es.string.anchor.js */ "../../node_modules/core-js/modules/es.string.anchor.js");
...
/* harmony import */ var Shared_ts_applications_navigation__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! Shared/ts/applications/navigation */ "../../Shared-International/ts/applications/navigation.ts");
/* harmony import */ var Shared_ts_observers_intersection__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! Shared/ts/observers/intersection */ "../../Shared-International/ts/observers/intersection.ts");
...
var PageSectionNav = /*#__PURE__*/ function () {
    function PageSectionNav(element) {
        var _this = this;
        this.element = void 0;
        this.combobox = void 0;
        this.candidates = [];
        this.root = window.getComputedStyle(document.documentElement, ":root");
        this.element = element;
        this.candidates = this.captureSectionCandidates();
        this.initializeScrollableHeight().then(function () {
            _this.observeTracker();
            _this.initializeAnchorActions();
            _this.initializeComboboxAction();
        }).catch(function (error) {
            return console.debug(error);
        });
    }
    var _proto = PageSectionNav.prototype;
    _proto.initializeScrollableHeight = /*#__PURE__*/ function () {
        var _initializeScrollableHeight = _asyncToGenerator(/*#__PURE__*/ regeneratorRuntime.mark(function _callee() {
            var _this2 = this;
            return regeneratorRuntime.wrap(function _callee$(_context) {
                while (1) {
                    switch (_context.prev = _context.next) {
                        case 0:
                            return _context.abrupt("return", new Promise(function (resolve, reject) {
                                ...
                                (0,Shared_ts_applications_navigation__WEBPACK_IMPORTED_MODULE_16__.importScrollableHeightByElement)(_this2.element, "page-section-nav-height");
                                var props = Array.from(document.styleSheets).filter(function (s) {
                                    var _s$href;
                                    return (_s$href = s.href) == null ? void 0 : _s$href.startsWith(window.location.origin);
                                }).flatMap(function (styleSheet) {
                                    return Array.from(styleSheet.cssRules);
                                }).filter(function (cssRule) {
                                    return cssRule instanceof CSSStyleRule && cssRule.selectorText === ":root";
                                }).flatMap(function (cssRule) {
                                    return Array.from(cssRule.style);
                                }).filter(function (style) {
                                    return style.startsWith("--page-section-nav-calc");
                                }).map(function (prop) {
                                    return "var(" + prop + ")";
                                }).join(" + ");
                                var style = document.createElement("style");
                                ...
                                requestIdleCallback(function () {
                                    var root = window.getComputedStyle(document.documentElement, ":root");
                                    resolve();
                                });
                            }));
                        case 1:
        ...
        function initializeScrollableHeight() {
            return _initializeScrollableHeight.apply(this, arguments);
        }
        return initializeScrollableHeight;
    }();
    _proto.observeTracker = function observeTracker() {
        var _this3 = this;
        if (!this.element)
            return;
        (0,Shared_ts_observers_intersection__WEBPACK_IMPORTED_MODULE_17__.observer)("page-section-nav-tracker", {
            inRange: function inRange() {
                var _this3$element;
                (_this3$element = _this3.element) == null ? void 0 : _this3$element.classList.remove("page-section-nav--is-scrolling");
            },
            outRange: function outRange() {
                var _this3$element2;
                (_this3$element2 = _this3.element) == null ? void 0 : _this3$element2.classList.add("page-section-nav--is-scrolling");
            },
            unObserve: false
        });
    };
    _proto.captureSectionCandidates = function captureSectionCandidates() {
        var element = this.element;
        if (!element)
            return [];
        return Array.from(element.querySelectorAll('a[href^="#"]')).map(function (a) {
            return {
                anchor: a,
    ...
    _proto.addActiveState = function addActiveState(candidate) {
    ...
    _proto.removeActiveState = function removeActiveState(candidate) {
        candidate.anchor.classList.remove("page-section-nav__active-item");
    };
    _proto.updateActiveStateByCandidate = function updateActiveStateByCandidate(candidate) {
        var _this4 = this;
        this.candidates.filter(function (c) {
            return c.anchor !== candidate.anchor;
        }).forEach(function (c) {
            return _this4.removeActiveState(c);
        });
        this.addActiveState(candidate);
    };
    _proto.initializeComboboxAction = function initializeComboboxAction() {
        var _this5 = this;
        var element = this.element;
        if (!element)
            return;
        var combobox = element.querySelector("select");
        if (!combobox)
            return;
        this.combobox = combobox;
        combobox.addEventListener("change", function (event) {
            event.preventDefault();
            var candidate = _this5.candidates.find(function (candidate) {
                return candidate.selector === combobox.value;
            });
            if (!candidate)
                return;
    ...
    _proto.getHash = function getHash() {
        var hash = window.location.hash;
        if (hash === "" || !this.candidates.map(function (candidate) {
            return candidate.selector;
        }).includes(hash))
            return "";
        return hash;
    };
    _proto.initializeAnchorActions = function initializeAnchorActions() {
        var _this6 = this;
        this.candidates.forEach(function (candidate) {
            (0,Shared_ts_observers_intersection__WEBPACK_IMPORTED_MODULE_17__.observer)(candidate.selector, {
                inRange: function inRange() {
                    return _this6.updateActiveStateByCandidate(candidate);
                },
                outRange: function outRange() {
                    return _this6.removeActiveState(candidate);
                },
                unObserve: false,
                options: {
                    root: null,
                    rootMargin: "-" + _this6.scrollableHeight + " 0px 0px"
                }
            });
            candidate.anchor.addEventListener("click", function () {
                requestAnimationFrame(function () {
                    _this6.updateActiveStateByCandidate(candidate);
                });
            });
        });
    };
    _createClass(PageSectionNav, [{
            key: "scrollableHeight",
            get: function get() {
                return this.root.getPropertyValue("scroll-padding-top");
            }
        }]);
    return PageSectionNav;
}();
...
/* harmony import */ var core_js_modules_web_dom_collections_for_each_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! core-js/modules/web.dom-collections.for-each.js */ "../../node_modules/core-js/modules/web.dom-collections.for-each.js");
/* harmony import */ var core_js_modules_web_dom_collections_for_each_js__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_web_dom_collections_for_each_js__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var Shared_ts_applications_form__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! Shared/ts/applications/form */ "../../Shared-International/ts/applications/form.ts");
/* harmony import */ var Shared_ts_applications_navigation__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! Shared/ts/applications/navigation */ "../../Shared-International/ts/applications/navigation.ts");
/* harmony import */ var Shared_ts_applications_template__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! Shared/ts/applications/template */ "../../Shared-International/ts/applications/template.ts");
/* harmony import */ var ts_applications_navigation__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ts/applications/navigation */ "./ts/applications/navigation.ts");
/* harmony import */ var Shared_ts_components_status_screen__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! Shared/ts/components/status-screen */ "../../Shared-International/ts/components/status-screen.ts");
/* harmony import */ var Shared_ts_components_accordion__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! Shared/ts/components/accordion */ "../../Shared-International/ts/components/accordion.ts");
/* harmony import */ var ts_components_page_section_nav__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ts/components/page-section-nav */ "./ts/components/page-section-nav.ts");
...
(0,Shared_ts_applications_template__WEBPACK_IMPORTED_MODULE_6__.initializeToolTip)();
var nav = (0,Shared_ts_applications_navigation__WEBPACK_IMPORTED_MODULE_5__.initializeNavById)("nav");
(0,Shared_ts_applications_navigation__WEBPACK_IMPORTED_MODULE_5__.importScrollableHeightByElement)(nav == null ? void 0 : nav.root);
var initializeValidateEventWithStatusScreen = function initializeValidateEventWithStatusScreen() {
    var _validateEvent$submit;
    ...
    if (!submit)
        return;
    var validateEvent = (0,Shared_ts_applications_form__WEBPACK_IMPORTED_MODULE_4__.initializeValidateEvent)(form, submit, "required");
    var statusScreen = new Shared_ts_components_status_screen__WEBPACK_IMPORTED_MODULE_8__["default"]();
    (_validateEvent$submit = validateEvent.submit) == null ? void 0 : _validateEvent$submit.addEventListener("click", function (event) {
        validateEvent.validateAll();
...
var initializeAccordions = function initializeAccordions() {
    var accordions = Array.from(document.querySelectorAll(".accordion"));
    accordions.forEach(function (accordion) {
        return new Shared_ts_components_accordion__WEBPACK_IMPORTED_MODULE_9__["default"](accordion);
    });
};
var initializePageSectionNav = function initializePageSectionNav() {
    var element = document.querySelector(".page-section-nav");
    if (!element)
        return;
    new ts_components_page_section_nav__WEBPACK_IMPORTED_MODULE_10__["default"](element);
};
initializePageSectionNav();
initializeAccordions();
(0,ts_applications_navigation__WEBPACK_IMPORTED_MODULE_7__.navigateToPageSectionOnLoad)();
